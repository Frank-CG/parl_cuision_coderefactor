...
class ExDayPicker extends StatefulWidget {
  ...
  @override
  _ExDayPickerState createState() => _ExDayPickerState();
}

class _ExDayPickerState extends State<ExDayPicker> {
  ...
  @override
  void didUpdateWidget(ExDayPicker oldWidget) {
...
class _DayPicker extends StatelessWidget {
  ...
  bool _isDisabled(DateTime day) {
    ...
    return day.isAfter(endOfTheLastDay) || day.isBefore(beginOfTheFirstDay) || (onlyWeekdays && (day.weekday > 5));
  }
