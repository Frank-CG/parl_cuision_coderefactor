  ...
  Widget build(BuildContext context) {
    return BlocBuilder(
      ...
      builder: (BuildContext context, NavState state) {
        ...
        final _bottomBarWidget = state.pageName.index == 3 ? null : BottomNavigationBar(
            onTap: (int index) { _navBloc.dispatch(NavTo(pageName: PageName.values[index], previousPageName: state.pageName)); },
